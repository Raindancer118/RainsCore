    ...
    class Presence {
        ...
        void ranks() {
            ...
            assertThat(directory.presenceOf(directory.byName("Alice").orElseThrow()))
                    .isEqualTo(de.raindancer.core.ui.choose.Presence.HERE);
            assertThat(directory.presenceOf(directory.byName("Carol").orElseThrow()))
                    .isEqualTo(de.raindancer.core.ui.choose.Presence.RECENTLY);
            assertThat(directory.presenceOf(directory.byName("Eve_2000").orElseThrow()))
                    ...
                    .isEqualTo(de.raindancer.core.ui.choose.Presence.LONG_AGO);
        }
        ...
        void inSections() {
            ...
            assertThat(sections.keySet())
                    .containsExactly(de.raindancer.core.ui.choose.Presence.HERE,
                            de.raindancer.core.ui.choose.Presence.RECENTLY,
                            de.raindancer.core.ui.choose.Presence.LONG_AGO);
            assertThat(sections.get(de.raindancer.core.ui.choose.Presence.HERE))
        ...
        void sectionsHaveChrome() {
            for (var presence : de.raindancer.core.ui.choose.Presence.values()) {
